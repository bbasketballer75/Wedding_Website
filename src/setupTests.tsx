...
vi.mock('framer-motion', () => {
  ...
  const MotionButton = ({ children, ...props }: any) => React.createElement('button', props, children)
  ...
  const MotionCircle = ({ children, ...props }: any) => React.createElement('circle', props, children)
