...
export const ClaimsModeration: React.FC = () => {
  ...
  const handleApprove = async (claim: PhotoClaim) => {
    ...
    try {
      ...
      addToast(
        `Claim for ${claim.guest_identities?.display_name} successfully approved!`,
        'success'
      )
      await loadClaims()
    } catch (err: any) {
      ...
      <AnimatePresence mode='wait'>
        {loading ? (
          ...
          >
            ...
            <p className='mt-4 text-sm text-charcoal-500 font-sans'>Loading claims database...</p>
          </motion.div>
        ) : claims.length === 0 ? (
          <motion.div
            ...
            >
              ...
              <form onSubmit={handleRejectSubmit} className='p-4 space-y-4'>
                <p className='text-xs text-charcoal-500 leading-normal'>
                  ...
                  ({rejectingClaim.guest_identities?.email}) is being rejected. This is logged to
                  the audit log.
                </p>
                ...
                <div className='space-y-1.5'>
                  <label
                    ...
                    className='block text-xs font-semibold uppercase tracking-wider text-charcoal-600'
                  >
                    Rejection Reason
                  </label>
                  <textarea
