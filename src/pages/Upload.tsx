          ...
          >
            ...
            <div className='relative'>
              ...
              <p className='mx-auto mt-4 max-w-2xl text-base text-white/55 sm:text-lg'>
                Your {uploadSummary}{' '}
                {completedPhotoCount + completedVideoCount === 1 ? 'is' : 'are'} uploaded and
                pending review. We’ll take a look and add the approved moments to the shared archive
                after review.
              </p>
              ...
              <div className='mt-8 grid gap-3 sm:grid-cols-3'>
                ...
                <div className='rounded-xl border border-gold-200/15 bg-white/5 px-4 py-4'>
                  ...
                  <p className='mt-2 text-sm leading-6 text-white/55'>
                    Photos can appear in the live gallery, and approved video clips can stay
                    private, join the guest-highlight lane, or become a featured moment later.
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <div className='relative'>
            ...
            <p className='mt-5 max-w-2xl text-base text-white/55 sm:text-lg'>
              Phone photos, shaky dance-floor videos, ceremony candids, quiet table moments: the
              whole archive gets better when your side of the day is part of it too.
            </p>
                                ...
                                <div className='flex items-center gap-4'>
                                  ...
                                  <div className='min-w-0'>
                                    ...
                                    <div className='mt-1 flex flex-wrap items-center gap-2 text-xs text-white/50'>
                                      ...
                                      <span className='h-1 w-1 rounded-full bg-gold-300' />
                                      <span>
                                        {file.file.type.startsWith('video/') ? 'Video' : 'Photo'}
                                      </span>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  {file.status === 'uploading' && (
                                    <div>
                                      <div className='mb-2 flex items-center justify-between text-xs text-white/50'>
                                        ...
                                        <span>
                                          {file.progress === 100 ? 'Processing…' : 'Sending'}
                                        </span>
                                      </div>
                                  ...
                                  {file.status === 'error' && (
                                    <div className='space-y-2'>
                                      ...
                                      <p className='text-xs leading-5 text-rose-300'>
                                        {file.errorMessage ||
                                          "This one didn't upload — try again or skip it"}
                                      </p>
                                      <button
                                        type='button'
          ...
          <div className='grid gap-6 xl:sticky xl:top-28 xl:self-start'>
            ...
            >
              ...
              <p className='mt-3 text-sm leading-6 text-white/55'>
                We only need enough information to credit the memories and send you a quick note
            ...
            >
              ...
              <ul className='mt-4 space-y-3 text-sm leading-6 text-white/55'>
                ...
                <li className='flex items-start gap-3'>
                  ...
                  Your contact details stay with the submission in case we need context while
                  reviewing it.
                </li>
                <li className='flex items-start gap-3'>
            ...
            >
              ...
              <p className='mt-3 text-sm leading-6 text-white/55'>
                You can submit once at least one file is marked ready and your contact details are
                filled in. Files that failed will stay out until you retry or remove them.
              </p>

              <div className='mt-4 rounded-xl border border-white/10 bg-white/5 px-4 py-4'>
                <p className='text-[10px] uppercase tracking-[0.28em] text-gold-400'>
                  What happens next
                </p>
                <p className='mt-3 text-sm leading-6 text-white/55'>
                  After you send, the upload enters a private review queue. Approved photos can be
                  published into the live gallery, while approved video clips can be kept private,
                  added to guest highlights, or featured later.
                </p>
              </div>
              ...
              <Button
                ...
                disabled={
                  files.length === 0 || !name || !email || isSubmitting || completedFiles === 0
                }
              >
                {isSubmitting ? (
                  <>
