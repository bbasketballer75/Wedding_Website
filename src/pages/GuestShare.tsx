            ...
            >
              {photos.length === 0 ? (
                <div className="text-center py-20 bg-white/40 backdrop-blur-md rounded-2xl border border-gold-200/20 px-4">
                  ...
                  <h3 className="font-serif text-lg font-semibold text-charcoal-800">No photos shared yet</h3>
                  <p className="mt-2 text-sm text-charcoal-500 max-w-sm mx-auto font-sans leading-relaxed">
                    Photos uploaded by this guest, or claimed in the gallery, will appear here once approved by the administrators.
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <div className="aspect-[4/3] w-full overflow-hidden bg-cream-50 relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-charcoal-900/60 via-charcoal-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 text-white">
                          ...
                          {photo.caption && (
                            <p className="text-sm font-sans truncate mb-1.5 font-medium">{photo.caption}</p>
                          )}
            ...
            >
              {guestbook.length === 0 ? (
                <div className="text-center py-20 bg-white/40 backdrop-blur-md rounded-2xl border border-gold-200/20 px-4">
                  ...
                  <h3 className="font-serif text-lg font-semibold text-charcoal-800">No guestbook messages yet</h3>
                  <p className="mt-2 text-sm text-charcoal-500 max-w-sm mx-auto font-sans leading-relaxed">
                    Personalized handwritten notes or well-wishes submitted to the guestbook will appear here once approved.
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {guestbook.map((msg, index) => (
                    <motion.article
                      ...
                      style={{
                        backgroundImage: 'linear-gradient(rgba(212, 175, 55, 0.07) 1px, transparent 1px)',
                        backgroundSize: '100% 2.25rem',
                        lineHeight: '2.25rem',
                      }}
                    >
                      {/* Note Header Card Details */}
                      <div className="flex items-center justify-between border-b border-gold-500/10 pb-3 mb-6" style={{ lineHeight: 'normal' }}>
                      ...
                      <div className="mt-8 flex flex-col items-end border-t border-gold-500/10 pt-4" style={{ lineHeight: 'normal' }}>
