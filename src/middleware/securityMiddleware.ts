...
export const CSP_DIRECTIVES = {
  ...
  'connect-src': ["'self'", 'https://*.supabase.co', 'https://*.netlify.app', 'https://media.wedding.theporadas.com', 'https://*.r2.dev', 'wss://*.supabase.co'],
  'media-src': ["'self'", 'data:', 'https://*.supabase.co', 'https://media.wedding.theporadas.com'],
  'object-src': ["'none'"],
  'frame-src': ["'self'"],
  'base-uri': ["'self'"],
  'form-action': ["'self'"],
