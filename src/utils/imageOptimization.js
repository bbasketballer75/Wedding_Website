...
export const generatePictureSources = (baseUrl, sizes = [640, 768, 1024, 1280], quality = 75) => {
  const sources = []
...
export const calculateOptimalSize = (containerWidth, containerHeight, aspectRatio) => {
...
export const createImageURL = (baseUrl, options = {}) => {
  const {
    width,
    height,
    quality = 75,
