import { ArrowUpRight, Heart, Play, Images, BookHeart, Printer } from 'lucide-react'
...
const footerLinks = [
  ...
  {
    title: 'Memory Book',
    description: 'Print a keepsake photo book or guestbook — save as PDF from any browser.',
    to: '/print',
    icon: Printer,
  },
] as const
          ...
          <div className='grid gap-10 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] xl:items-start'>
            <div className='max-w-xl'>
              ...
              <p className='mt-4 max-w-lg text-sm leading-7 text-cinematic-secondary sm:text-base'>
                The simplest way through is still the best one: watch the film, open the gallery
                when you want to linger, and leave a note only if you still have something to say
                before you go.
              </p>
