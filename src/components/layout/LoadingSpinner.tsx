...
type SpinnerVariant = 'spinner' | 'skeleton'
type SkeletonType = 'card' | 'list' | 'gallery' | 'text'
  ...
  if (variant === 'skeleton') {
    return (
      <div className='w-full p-4'>
        ...
        {skeletonType === 'gallery' && <GallerySkeleton count={3} />}
        {skeletonType === 'text' && <TextSkeleton lines={3} />}
      </div>
    )
  }
