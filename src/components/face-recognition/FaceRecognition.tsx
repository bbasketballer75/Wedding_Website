                ...
                <div className='flex items-start justify-between gap-4'>
                  <div>
                    ...
                    <p className='mt-2 max-w-2xl text-sm leading-6 text-charcoal-500'>
                      This view filters the gallery by real face tags from the archive. It is
                      review-backed metadata, not a live selfie matcher.
                    </p>
                  </div>
                  <button
                    type='button'
                ...
                {filteredFaces.length === 0 ? (
                  <div className='flex min-h-[16rem] flex-col items-center justify-center rounded-[1.8rem] border border-dashed border-gold-200/80 bg-white/65 px-6 text-center'>
                    ...
                    <p className='mt-2 max-w-md text-sm leading-6 text-charcoal-500'>
                      Try a broader name, or clear the search to browse everyone we have confirmed
                      so far.
                    </p>
                  </div>
                ) : (
                      ...
                      >
                        <div className='flex items-start gap-4'>
                          ...
                          <div className='min-w-0 flex-1'>
                            <p className='font-display text-2xl text-charcoal-900'>{face.name}</p>
                            <p className='mt-1 text-sm text-charcoal-500'>
                              {face.photoCount} tagged {face.photoCount === 1 ? 'photo' : 'photos'}
                            </p>
                            <div className='mt-3 flex flex-wrap gap-2'>
                              {typeof face.professionalCount === 'number' &&
                                face.professionalCount > 0 && (
