...
const CornerSpiderWeb = ({ corner, isVisible }) => {
  ...
  const getPoint = (radius = 0, angleDeg = 0, customOx = null, customOy = null) => {
...
const Spider = ({ startRadius, angle, delay, getPoint, safeFmt, originX, originY, isVisible }) => {
    ...
    >
      <g transform={`translate(${safeFmt(startPt.x)}, ${safeFmt(startPt.y)})`}>
        ...
        {[
          ...
          if (path.includes('NaN') || path.includes('undefined')) return null
