...
const PersonCard = React.memo(({ person, size = 'normal', onClick }) => {
  // Simplified size logic - focusing on aspect ratio and text size
  const textSize = {
    large: {
    ...
    >
      ...
      <div className='relative w-full aspect-square mb-6 transition-transform duration-500'>
        ...
        >
          ...
          {/* The Ring Border - Sits perfectly on top of the clip path */}
          <circle
            cx='50'
            cy='50'
            r='48.5'
            fill='none'
            stroke={person.side === 'groom' ? '#d4af37' : '#f9dbe2'} // Gold-500 or Pale Pink (Rose-200)
            strokeWidth='3'
