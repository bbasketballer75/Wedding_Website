...
interface PartyMemberModalProps {
  selectedMember: WeddingPartyPerson | null
  onClose: () => void
}

const PartyMemberModal = ({ selectedMember, onClose }: PartyMemberModalProps) => {
          ...
          >
            ...
            <div className='p-12 px-10'>
              ...
              <div className='mt-8 flex justify-center'>
                ...
                >
                  {selectedMember.side === 'groom' ? "Groom's Side" : "Bride's Side"}
                </span>
              </div>
            </div>
          </motion.div>
