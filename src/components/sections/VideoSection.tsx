...
const parentVideos: ParentVideo[] = [
...
const formatChapterTime = (timeInSeconds: number) => {
...
const VideoSection: React.FC = () => {
  ...
  const [selectedFamilyVideo, setSelectedFamilyVideo] = useState<ParentVideo | null>(null)
  const [showCastTip, setShowCastTip] = useState<boolean>(() => {
  ...
  return (
    <section id='video' className='py-20 bg-cream-50'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          <h2 className='text-4xl font-bold font-display text-dark-900 mb-4'>The Wedding Film</h2>
          <p className='text-lg font-light text-dark-700/60'>
            A cinematic archive of our celebration and the stories shared throughout the day.
          </p>
        </motion.div>
