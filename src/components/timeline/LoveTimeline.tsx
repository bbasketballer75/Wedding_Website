...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    title: 'The Meeting',
    description:
      'We met during a summer at work and somehow the ordinary days started feeling a lot less ordinary. It did not take long for us to realize something bigger was beginning.',
    side: 'left',
    media: {
      type: 'icon',
  ...
  },
  {
    ...
    title: 'First Date',
    description:
      'This was the point where talking turned into choosing each other on purpose. It felt easy, exciting, and like the start of the version of life we actually wanted.',
    side: 'right',
    media: {
      type: 'icon',
  ...
  },
  {
    ...
    description:
      'We packed up, landed in Ligonier, and started building a life that finally felt like ours. New town, new routines, same certainty that we were doing it together.',
  ...
  },
  {
    ...
    description:
      'Keys in hand, we stepped into the first place that was truly ours. It was the beginning of quiet nights, shared projects, and all the little rituals that make a house feel like home.',
    side: 'right',
    media: {
      type: 'map',
  ...
  },
  {
    ...
    description:
      'Moira and Stella made the house feel instantly fuller, louder, and more us. Our little family grew by two and never looked back.',
    side: 'left',
    media: {
      type: 'carousel',
      config: {
  ...
  },
  {
    ...
    title: 'The Proposal 💍🎃',
    description:
      'On Halloween night, in full costume and fully committed to the bit, Austin asked the question that changed everything. It was weird, perfect, emotional, and completely us.',
  ...
  },
  {
    ...
    description:
      'A full weekend in Pittsburgh with the people who know us best: loud laughs, late nights, and the kind of memories that only happen when everyone shows up big.',
    location: 'Pittsburgh, PA',
    side: 'left',
    media: {
      type: 'carousel',
      config: {
        folder: 'bachelor_ette__1nlhm4u',
  ...
  },
  {
    ...
    description:
      'One of those gentler celebrations we will always remember. It was full of love, stories, and the feeling that the wedding was finally close enough to touch.',
  ...
  },
  {
    ...
    description:
      'The day all of these chapters finally met in one room. Surrounded by our people, we said yes again, this time out loud and for good.',
...
// NOTE: filenames here must exactly match R2 object keys under media/timeline/
const mediaFiles: Record<string, string[]> = {
  cats: [
    '20210128_150848_4__1r5aqbl.jpg',
    'PXL_20240114_184414874_2__1a7yin.jpg',
...
function getImagePaths(folder: string, count: number): string[] {
  ...
  return imageFiles
    ...
    .map(file => getMediaPath(`${MEDIA_BASE_PATH}/${folder}/${file}`))
}
    ...
    >
      ...
      >
        ...
        <svg className='absolute top-0 right-0 w-28 h-28 opacity-40' viewBox='0 0 100 100'>
          <path
            d='M100,0 L100,100 M100,0 L0,0 M100,0 L50,50'
            stroke='#DC2626'
            strokeWidth='0.8'
            fill='none'
            opacity='0.6'
          />
          <path
            d='M100,20 L70,20 M100,40 L80,40 M100,60 L90,60'
            stroke='#7F1D1D'
            strokeWidth='0.5'
            fill='none'
            opacity='0.4'
          />
          <path
            d='M80,0 L80,30 M60,0 L60,20 M40,0 L40,15'
            stroke='#991B1B'
            strokeWidth='0.5'
            fill='none'
            opacity='0.3'
        ...
        {/* Cobweb - Bottom Left */}
        <svg
          className='absolute bottom-0 left-0 w-20 h-20 opacity-30 rotate-180'
          viewBox='0 0 100 100'
        >
          <path
            d='M100,0 L100,100 M100,0 L0,0 M100,0 L50,50'
          ...
          />
          <path
            d='M100,25 L75,25 M100,50 L85,50'
            stroke='#7F1D1D'
            strokeWidth='0.5'
            fill='none'
            opacity='0.3'
        ...
        <div className='relative z-10'>
          ...
          <h3 className='mb-3 font-display text-[2.15rem] leading-none text-white md:text-[3rem]'>
            ...
            <span className='ml-2 text-candle-100 drop-shadow-[0_0_24px_rgba(255,247,235,0.12)]'>
              {' '}
              Proposal
            </span>
            <span className='ml-3 inline-block text-fuchsia-200 drop-shadow-[0_0_18px_rgba(244,114,182,0.65)]'>
              💍
            </span>
          </h3>
          ...
          <p className='mb-4 text-sm leading-relaxed text-[#f8e7ea] md:text-base'>
            On All Hallows&apos; Eve, with the costumes on, the music up, and the whole night
            already feeling half haunted and half electric, Frankenstein finally asked his Bride the
            question that had been building toward forever.
          </p>
          ...
          <motion.p
            animate={{
              opacity: [1, 0.68, 1],
              textShadow: [
                '0 0 14px rgba(244,114,182,0.38)',
                '0 0 24px rgba(251,191,36,0.46)',
                '0 0 14px rgba(244,114,182,0.38)',
              ],
            }}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className='absolute inset-0 bg-gradient-to-br from-gold-50/80 via-transparent to-rose-50/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500' />
          ...
          <div className='mb-6'>
            ...
            {event.media.type === 'icon' && (
              <TimelineIcon
                type={
                  (
                    event.media.config as {
                      iconType: 'meeting' | 'first-date' | 'wedding' | 'generic'
                    }
                  ).iconType
                }
              />
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{
          y: -6,
          boxShadow: '0 30px 60px -15px rgba(198,156,78,0.3)',
          borderColor: 'rgba(198,156,78,0.6)',
        }}
        transition={{ duration: 0.3 }}
...
export function LoveTimeline() {
  ...
  return (
    <section
      id='love-timeline'
      ref={containerRef}
      className='relative py-24 px-4 bg-gradient-to-b from-cream-50 via-gold-50/30 to-cream-100 overflow-hidden'
    >
