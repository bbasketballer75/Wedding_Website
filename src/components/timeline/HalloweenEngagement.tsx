...
export function HalloweenEngagement() {
  ...
  return (
    <>
      <section ref={sectionRef} className='relative min-h-[80vh] py-24 overflow-hidden'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto px-4'>
          ...
          {/* Audio Toggle */}
          <motion.div className='absolute top-8 left-8' whileHover={{ scale: 1.05 }}>
            <button
              onClick={() => setAudioEnabled(!audioEnabled)}
              className={cn(
                'p-2 rounded-full transition-all',
                audioEnabled ? 'bg-green-500/20 text-green-400' : 'bg-white/10 text-white/60'
              )}
            >
          ...
          <audio ref={audioRef} loop src='/audio/spooky-ambience.mp3'>
            <track
              kind='captions'
              srcLang='en'
          ...
          >
            ...
            >
              On the spookiest night of the year, our love story took a monstrous turn. Dressed as
              Frankenstein&apos;s Monster and his Bride, under a full moon and surrounded by
              Halloween magic, Austin asked Jordyn to be his forever.
              <br />
              <br />
              <span
                className={cn(
        ...
        <div
          className={cn(
            ...
            isSpooky ? 'from-cream-50 to-transparent' : 'from-cream-50 to-transparent'
          )}
        />
      </section>
    </>
