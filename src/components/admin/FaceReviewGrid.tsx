                  ...
                  <div className="grid gap-4 md:grid-cols-[10rem_minmax(0,1fr)]">
                    ...
                    <div className="space-y-4 rounded-[1.4rem] border border-gold-100 bg-cream-50/70 p-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {selectedGroupFace ? (
                          <Button size="sm" variant="secondary" onClick={() => onOpenPhotoInspector(selectedGroupFace)}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            const currentIndex = selectedGroup.faces.findIndex((face) => face.id === selectedGroupFaceId)
