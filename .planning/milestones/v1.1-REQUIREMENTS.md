...
- [x] **MOD-01**: Admin can approve guest uploads with one click
- [x] **MOD-02**: Admin can reject guest uploads with reason
- [ ] **MOD-03**: Admin can feature/spotlight approved content to homepage

### Gallery

- [x] **GAL-01**: Gallery virtualizes 200+ photos using @tanstack/react-virtual — only visible items rendered
- [x] **GAL-02**: Guest can add/remove heart reaction on guestbook entries with optimistic UI
- [ ] **GAL-03**: Featured spotlight content appears on homepage in designated editorial slot

### Social

- [x] **SOC-01**: Share button passes photo-specific URL as og:image for dynamic social previews
- [x] **SOC-02**: Share modal shows preview of what will be shared (title, image, description)

### Upload

- [x] **UPL-01**: Incomplete uploads persist to localStorage and can be resumed after page refresh
- [x] **UPL-02**: Guest sees "Your photo is being reviewed" status with email-based lookup
...
| MOD-01 | Phase 8 (v1.1) | Done |
| MOD-02 | Phase 8 (v1.1) | Done |
| MOD-03 | Phase 8 (v1.1) | Deferred |
| GAL-01 | Phase 7 (v1.1) | Done |
| GAL-02 | Phase 6 (v1.1) | Done |
| GAL-03 | Phase 8 (v1.1) | Deferred |
| SOC-01 | Phase 5 (v1.1) | Done |
| SOC-02 | Phase 5 (v1.1) | Done |
| UPL-01 | Phase 5 (v1.1) | Done |
| UPL-02 | Phase 6 (v1.1) | Done |

**Coverage:**
- v1 requirements: 18 total, 18 done
- v1.1 requirements: 11 total, 9 done (MOD-03, GAL-03 deferred)
- Unmapped: 0
